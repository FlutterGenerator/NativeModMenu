...
Java_uk_lgl_modmenu_FloatingModMenu_setTitleText(JNIEnv *env, jobject thiz, jobject obj) {
...
JNIEXPORT void JNICALL
Java_uk_lgl_modmenu_FloatingModMenu_setHeadingText(JNIEnv *env, jobject thiz, jobject obj) {
...
Java_uk_lgl_modmenu_FloatingModMenu_Icon(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jstring JNICALL
Java_uk_lgl_modmenu_FloatingModMenu_IconWebViewData(JNIEnv *env, jobject thiz) {
    return NULL;
}

JNIEXPORT jobjectArray JNICALL
Java_uk_lgl_modmenu_FloatingModMenu_settingsList(JNIEnv *env, jobject activityObject) {
    jobjectArray ret;
